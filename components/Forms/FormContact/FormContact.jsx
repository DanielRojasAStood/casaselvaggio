          ...
          <div className={cx("grid")}>
            <div className={cx("form")}>
              <form onSubmit={handleSubmit} className="contact__form">
                ...
                <button type="submit" className={cx(["button", "button button--primary button--right"])}>
                  Enviar
                </button>
              </form>
            </div>
            <div className={cx("info")}>
              <Link className={cx("link")} href="mailto:info@yourdomain.com">
                <span><IconEnvelope /></span>
                info@yourdomain.com
              </Link>
              <Link className={cx("link")} href="tel:+13784001234">
                <span><IconPhone /></span>
                +1 (378) 400-1234
              </Link>
              <Link className={cx("link")} href="www.yourdomain.com">
                {" "}
                <span><IconWorld /></span>
                www.yourdomain.com
              </Link>
